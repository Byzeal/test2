...
uav.elevator.max = 30/180*pi;
uav.elevator.min = -30/180*pi;
uav.aileron.max = 30/180*pi;
uav.aileron.min = -30/180*pi;
uav.rudder.max = 30/180*pi;
uav.rudder.min = -30/180*pi;
uav.flap.max = 10/180*pi;
uav.flap.min = -10/180*pi;
uav.controlsurfacemax = 90/180*pi;
uav.throttlepercent.max = 1;
uav.throttlepercent.min = 0;
uav.attitudectrlmax.roll = 20/180*pi;
uav.attitudectrlmax.pitch = 20/180*pi;
uav.attitudectrlmax.yawrate = 2/180*pi;
uav.attitudectrlmax.tpercent = 1;
uav.speed.max = 20;
uav.altitude.max = 100;

%% Initial Condition
% Line test
% uav.ic = struct;
% uav.ic.Pos_0 = [0; 0; 50];
% uav.ic.Euler_0 = [0; 0; pi/4];
